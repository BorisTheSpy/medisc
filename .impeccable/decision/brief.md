...
Scoring a hole "strikes" the chip: the new number snaps in with a 120ms lime flash and the previous value decays; no tweening of numerals. One authored moment: on entering a hole the overlay bar slides in from the left like a timing screen; reduced motion disables it.
